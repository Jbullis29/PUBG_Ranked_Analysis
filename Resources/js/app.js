...
enter.addEventListener("mouseenter", function (){
  document.getElementById("enterText").innerHTML = "ENTER HERE";
});

enter.addEventListener("mouseleave", function (){
  document.getElementById("enterText").innerHTML = "The LARPers";
});
// enter.addEventListener("mouseleave", function( event ) {
